...
namespace CustomEditors.CustomAttributes
{
    ...
    public class DrawIfPropertyDrawer : PropertyDrawer
    {
        ...
        {
            if (!ShowMe(property) && drawIf.DisablingTypeAttribute == DrawIfAttribute.DisablingType.DontDraw) {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            else if (drawIf.DisablingTypeAttribute == DrawIfAttribute.DisablingType.ReadOnly)
            {
                GUI.enabled = false;
                EditorGUI.PropertyField(position, property, label);
                GUI.enabled = true;
